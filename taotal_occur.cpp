...
int main()
{
    ...
    int p = frst_lst(arr,n,k);
    cout<<"total no. of occurence is : "<<p;
}
...
int frst_lst(int arr[] , int n , int k)
{
    int p,q,r;
    p = first_occur(arr,n,k);
    q = last_occur(arr,n,k);
    r = (q-p)+1;
    return r;
}